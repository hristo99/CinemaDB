...
const insertProjections = `INSERT INTO Projections
    (CinemaMovieId, HallId, StartTime, VideoFormat, Translation, PriceCategoryId)
VALUES
    ...
    ( 2, 5, '2017-12-10 11:50:00', '2d', 'sub', 1),
    ( 2, 5, '2017-12-10 14:50:00', '2d', 'sub', 1),
    ( 2, 5, '2017-12-10 17:50:00', '2d', 'sub', 1),
    ( 2, 5, '2017-12-10 20:50:00', '2d', 'sub', 1),
    ( 3, 7, '2017-12-11 12:50:00', '2d', 'sub', 1),
    ( 3, 7, '2017-12-11 15:50:00', '2d', 'sub', 1),
    ( 3, 7, '2017-12-11 18:50:00', '2d', 'sub', 1),
    ( 3, 7, '2017-12-11 21:50:00', '2d', 'sub', 1),
    ( 4, 2, '2017-12-10 11:50:00', '3d', 'none', 2),
    ( 4, 2, '2017-12-10 16:40:00', '3d', 'none', 2),
    ( 4, 2, '2017-12-10 22:50:00', '3d', 'none', 2),
    ( 5, 2, '2017-12-22 16:30:00', '3d', 'dub', 2),
    ( 5, 3, '2017-12-23 14:20:00', '3d', 'dub', 2),
    ( 6, 4, '2017-12-23 14:20:00', '3d', 'dub', 2),
    ( 6, 4, '2017-12-23 18:20:00', '3d', 'dub', 2),
    ( 7, 8, '2018-01-21 14:00:00', '3d', 'none', 2),
    ( 7, 8, '2018-01-21 17:00:00', '3d', 'none', 2),
    ( 7, 8, '2018-01-21 20:00:00', '3d', 'none', 2),
    ( 8, 2, '2017-12-10 12:00:00', '2d', 'sub', 1),
    ( 8, 2, '2017-12-10 15:40:00', '2d', 'sub', 1),
    ( 8, 2, '2017-12-10 18:55:00', '2d', 'sub', 1),
    ( 9, 4, '2017-12-15 18:00:00', '2d', 'sub', 1),
    ( 9, 4, '2017-12-16 18:00:00', '2d', 'sub', 1),
    ( 10, 6, '2017-12-17 10:00:00', '2d', 'none', 1),
    ( 10, 6, '2017-12-17 13:00:00', '2d', 'none', 1),
    ( 10, 7, '2017-12-17 10:00:00', '2d', 'none', 1),
    ( 10, 7, '2017-12-17 13:00:00', '2d', 'none', 1),
    ( 11, 3, '2017-12-30 16:00:00', '2d', 'sub', 1),
    ( 12, 8, '2017-12-22 19:45:00', '2d', 'none', 1),
    ( 12, 8, '2017-12-23 19:45:00', '2d', 'none', 1),
    ( 12, 8, '2017-12-24 19:45:00', '2d', 'none', 2);`;
...
const insertComments = `INSERT INTO Comments
    (MovieId, UserId, Text, Date)
VALUES
    ( 1, 2, 'I havent watched the movie but its good :)', '2017-12-14 22:34:58'),
    ( 1, 1, 'How is that a comedy?', '2017-12-14 22:58:09'),
    ( 2, 3, 'My brain hurts', '2017-12-01 19:33:17'),
    ( 3, 2, 'And they found Dory. Oops that was a spoiler.', '2017-11-30 14:00:44'),
    ( 5, 5, 'Good for kids', '2018-12-25 01:17:08'),
    ( 6, 6, 'They didnt mention China so its good. But they didnt build a wall with Mexico. So its bad', '2017-12-20 17:12:00');`;
connection.query(insertComments, err => {
    if (err) throw err;
    console.log("Inserted comments");
});

const insertSeats = `INSERT INTO Seats
    (HallId, Row, Position)
VALUES
    (1, 1, 1),
    (1, 1, 2),
    ...
    (8, 3, 5),
    (8, 3, 6);`;
connection.query(insertSeats, err => {
    if (err) throw err;
    console.log("Inserted seats");
});

const insertNotificationTypes = `INSERT INTO NotificationTypes
    (Subject)
VALUES
    ('friend request'),
    ('projection reminder'),
